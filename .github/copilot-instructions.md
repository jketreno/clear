...
Fill in the bracketed values from the actual files. Show this block **once per conversation**. If `clear/autonomy.yml` is missing, tell the user to run `./scripts/setup-clear.sh`.
