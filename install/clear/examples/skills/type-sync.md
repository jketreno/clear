...
7. **Run** `./clear/verify-ci.sh` — the type-compatibility architecture test must pass
...
The architecture test `clear/examples/architecture-tests/type-compatibility.test.ts` catches drift.
