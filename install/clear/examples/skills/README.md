...
See the generic skills in `clear/templates/skills/` (`autonomy-bootstrap.md`, `mcp-server.md`, `review.md`) for project-agnostic skills that work without customization.

## Installing examples into your project

Copy individually:
```bash
cp clear/examples/skills/api-endpoint.md .github/prompts/api-endpoint.prompt.md
```
