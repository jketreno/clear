...
Remind the user: "Consider adding an architecture test that validates this boundary is respected. See `clear/templates/architecture-tests/autonomy-guard.test.js` for an example."
